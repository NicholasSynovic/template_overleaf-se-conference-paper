...
\begin{abstract}
% Mini‑paragraph 1: establish domain, then pivot to the core problem and its consequences.
% Target: Sentences 1–3.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 

% Mini‑paragraph 2: state ‘In this paper, we…’ and summarize design/method at one‑sentence granularity, including scope (data size, systems, participants).
% Target: Sentences 4–5.
Tempus leo eu aenean sed diam urna tempor. 
Pulvinar vivamus fringilla lacus nec metus bibendum egestas. 

% Mini‑paragraph 3: headline result, supporting insight, and a concrete impact statement for practice/future research (no detailed numbers or stats).
% Target: Sentences 6–8.
...
% Intro arc: Paragraphs/blocks move from broad context → specific gap → overall approach → contributions → significance → roadmap.
% =========================================================================
...
% Function: Optional “headline results + scope” preview block.
% Target: 3–5 sentences.
% Content: Provide 1–2 headline quantitative or qualitative outcomes, plus a brief statement of scope/assumptions (where it works, where it might not). Do not repeat details from the Results; this is a teaser.
...
% Function: Manuscript outline.
% Target: 2–4 sentences.
% Content: Walk the reader through the structure of the paper in order (Background → Methodology → RQ evaluations → Discussion → Threats → Conclusion). Mention section IDs explicitly so the roadmap doubles as a structural map.
\myparagraph{Paper Outline}
This paper is organized as follows: 
\Cref{sec:background} provides essential background and reviews related work, 
\Cref{sec:methodology} describes Lorem ipsum dolor sit amet consectetur adipiscing elit,
\Cref{sec:rq1} Lorem ipsum dolor sit amet consectetur adipiscing elit,
\Cref{sec:rq2} Lorem ipsum dolor sit amet consectetur adipiscing elit, and
\Cref{sec:rq3} Lorem ipsum dolor sit amet consectetur adipiscing elit.
The paper concludes in \Cref{sec:discussion} with a discussion of implications for the software engineering community and future work, followed by an examination of potential threats to validity in \Cref{sec:threats}.
...
% --- THE FORMAL RQ LIST ---
% Comment: List 3–4 concise RQs, each focusing on one dimension (e.g., prevalence, patterns, impact). Keep each RQ to a single sentence, with an optional bolded dimension label.
...
% Target: 6–8 sentences.
% Content: Restate RQ2 verbatim, explain its role relative to other RQs.
Lorem ipsum dolor sit amet consectetur adipiscing elit.
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis.
Tempus leo eu aenean sed diam urna tempor. 
...
% Formal ‘Answer to RQ2’ box: 2–3 sentences of neutral synthesis.
\input{figures/template_finding}
...
% Formal ‘Answer to RQ3’ box: 2–3 sentences of neutral synthesis.
\input{figures/template_finding}
...
% Target: Optional 5–7 sentences on implications for standards, curricula, or broader scientific practice.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
Tempus leo eu aenean sed diam urna tempor. 
...
% Content: Explain potential confounding variables and how they may distort causal interpretations; mention mitigation strategies.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
Tempus leo eu aenean sed diam urna tempor. 
...
% Content: Discuss history, maturation, instrumentation effects and their potential influence on outcomes; note how design choices attempt to control them.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
Tempus leo eu aenean sed diam urna tempor. 
...
% Content: Describe attrition/missing data patterns and how they were handled (e.g., exclusion, imputation, sensitivity analysis).
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
...
% Content: Context & generalizability: clarify the study setting and domains, and explicitly state where the results may or may not generalize.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
Tempus leo eu aenean sed diam urna tempor. 
...
% Content: Sampling bias: discuss how selection of projects/participants may skew results and how that limits external validity.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
...
% Content: Indirect metrics: justify that chosen metrics capture intended constructs, referencing prior work and triangulation where possible.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
Tempus leo eu aenean sed diam urna tempor. 
...
% Content: Measurement error: address logging inaccuracies, self‑report biases, and tool limitations; explain how they might affect interpretations.
Lorem ipsum dolor sit amet consectetur adipiscing elit. 
Quisque faucibus ex sapien vitae pellentesque sem placerat. 
In id cursus mi pretium tellus duis convallis. 
Tempus leo eu aenean sed diam urna tempor. 
